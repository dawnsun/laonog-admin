...
import com.laonog.weixin.util.http.HttpResponseProxy;
 ...
 */
public class OkHttpMediaDownloadRequestExecutor extends
    BaseMediaDownloadRequestExecutor<OkHttpClient, OkHttpProxyInfo> {
